...
describe('ViewTabs Component', () => {
  describe('Rendering', () => {
    ...
    it('renders tabs with correct labels', () => {
      ...
      expect(labels).toEqual(['Arrange', 'Mixer', 'Audio', 'Video', 'Sync', 'Platforms', 'Files']);
    });
    ...
    it('renders tabs with correct data-tab attributes', () => {
      ...
      expect(ids).toEqual(['arrange', 'mixer', 'audio', 'video', 'sync', 'platforms', 'files']);
    });
  ...
  describe('Interaction', () => {
    ...
    it('each tab button is clickable', async () => {
      const tabIds = ['arrange', 'mixer', 'audio', 'video', 'sync', 'platforms', 'files'];
    ...
    it('works with different initial active tabs', () => {
      const tabs = ['arrange', 'mixer', 'audio', 'video', 'sync', 'platforms', 'files'];
